...
<div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1528041119984-da3a9f8d04d1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGlzbmV5bGFuZHxlbnwwfHwwfHx8MA%3D%3D')",
          height: "800px",
          width: "100%",
        ...
        <div className="mask">
          <div className="d-flex justify-content-center align-items-center h-100">
            <div className="text-white">
              <p className="d-flex align-items-center fw-bold text-center text-black text-white "style={{ fontSize:"5rem"}}>
      Contact us / book now
              </p>
              <h2 className="mb-3 text-black text-white ">We are here to help you plan your trip</h2>
            </div>
          </div>
        </div>
      </div>
...
<section class="bg-light py-3 py-md-5 container">

    <p className="text-dark  fw-bold text-center mx-auto mb-5 " style={{ fontSize:"3rem"}}>CONTACT INFO SECTION</p>
  <div class="container">
...
<div class="container mt-5">
    <h1 class="mb-4 "  style={{ fontSize:"3rem"}}>Plan Your Trip</h1>
    <form>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="travellers" required>
...
<section className="container mt-4 mb-5">
    <p className="text-dark  fw-bold text-center mx-auto mb-5 " style={{ fontSize:"3rem"}}>MAP LOCATIONS</p>
<div class="row w-100 ">
  ...
  <div class="col-lg-6 my-4 d-flex align-items-center">
    <div>
      ...
      <p>This useful feature helps to make your embedded map responsive (<strong>mobile
          friendly</strong>). You can customize responsive behavior with the use of.
</p>
      <p>This text looks so nice because it's <strong>vertically centered</strong> you can achieve
        this effect using the 
           layout option.</p>
    </div>
  </div>
</div>
